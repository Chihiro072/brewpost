...
export const Landing: React.FC = () => {
  ...
  const features = [
    {
      ...
      description:
        'Generate stunning social media posts, blog headers, and marketing content with AI.',
    },
    {
      icon: Target,
      title: 'Visual Planning',
      description:
        'Connect and organize your content with intuitive drag-and-drop node planning.',
    },
    {
      icon: Calendar,
      title: 'Smart Scheduling',
      description:
        'Schedule your content across platforms with intelligent timing suggestions.',
    },
  ];
  ...
  useEffect(() => {
    ...
    const rings = Array.from(
      document.querySelectorAll<SVGPathElement>('.snapshot-ring')
    );
  ...
  useEffect(() => {
    ...
    const elems = Array.from(
      document.querySelectorAll<HTMLElement>('.pricing-amount')
    );
      ...
      <header className="relative z-10 px-6 py-8">
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          <Button
            ...
            size="sm"
            variant="outline"
            className="border-primary/30 hover:border-primary/60 bg-card/50 backdrop-blur-sm"
          >
            Sign In
          </Button>
        </div>
          ...
          <section className="text-center mb-32">
            <div className="relative max-w-6xl mx-auto">
              ...
              <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground mb-12 leading-relaxed max-w-4xl mx-auto">
                Create, plan,and schedule stunning content with AI-powered
                tools. Connect your ideas visually and watch your content
                strategy come to life with intelligent automation.
              </p>
                ...
                {[
                  {
                    pct: 67,
                    title:
                      "didn't realize the importance of digital marketing strategy",
                    source: 'Mayple',
                  },
                  {
                    pct: 60,
                    title: 'of marketing budgets are inefficiently wasted',
                    source: 'Proxima',
                  },
                  {
                    pct: 90,
                    title: 'of SMEs are struggling with social media presence',
                    source: 'Blueiris',
                  },
                ].map((s, i) => (
                  <div
                    key={i}
                    className="p-6 bg-card/20 backdrop-blur-sm rounded-2xl border border-primary/10 flex flex-col items-center text-center"
                  >
                ...
                <div className="flex items-center gap-8 mb-6">
                  <div className="flex flex-col items-start">
                    ...
                    <div className="text-sm text-muted-foreground mt-2">
                      96.1% of businesses in Malaysia are SMEs (2024)
                    </div>
                  </div>
                </div>
          ...
          <section className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Experience the power of visual content planning. Watch your
                ideas connect and flow in real-time.
              </p>
            </div>

            <Card
              className="p-12 bg-card/20 backdrop-blur-xl border border-primary/20 relative overflow-hidden"
                      ...
                      >
                        ...
                        <div className="relative z-10">
                          <div className="flex items-center gap-3 mb-3">
                            <div
                              className={`w-12 h-12 ${colors.bg} rounded-xl flex items-center justify-center shadow-xl relative overflow-hidden`}
                            >
                              <TypeIcon className="w-6 h-6 text-white" />
                              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent animate-sweep"></div>
                            </div>
                            <h5 className="text-lg font-bold truncate text-foreground">
                              {node.title}
                            </h5>
                          </div>
            ...
            <div className="max-w-7xl mx-auto text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="p-8 bg-card/10 rounded-2xl border border-gray-300/20 dark:border-gray-700/30">
                  <div className="text-sm font-semibold mb-4">Basic</div>
                  <div className="text-5xl font-extrabold mb-4">
                    ${' '}
                    <span className="pricing-amount" data-target="9">
                      0
                    </span>
                  </div>
                ...
                <div className="p-8 bg-gradient-primary rounded-2xl border border-primary/10 transform scale-105 shadow-2xl">
                  <div className="text-sm font-semibold mb-4">Pro</div>
                  <div className="text-6xl font-extrabold mb-4">
                    ${' '}
                    <span className="pricing-amount" data-target="19">
                      0
                    </span>
                  </div>
                  <ul className="text-left text-sm list-disc pl-6">
                ...
                <div className="p-8 bg-card/10 rounded-2xl border border-gray-300/20 dark:border-gray-700/30">
                  <div className="text-sm font-semibold mb-4">Unlimited</div>
                  <div className="text-5xl font-extrabold mb-4">
                    ${' '}
                    <span className="pricing-amount" data-target="29">
                      0
                    </span>
                  </div>
                  <ul className="text-left text-sm list-disc pl-6">
